...
export default function Sidebar() {
    ...
    return (
        <LayoutGroup>
            {/* --- ULTIMATE GLASS MOBILE DOCK (Phone Experience) --- */}
            <nav className="lg:hidden fixed bottom-6 left-5 right-5 z-[100] bg-white/40 dark:bg-slate-950/60 backdrop-blur-3xl border border-white/20 dark:border-slate-800 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] rounded-[3rem] px-2 py-3 overflow-hidden">
                <div className="flex items-center overflow-x-auto no-scrollbar gap-2 relative px-2">
                    ...
                    {/* Mobile Logout: Placed at the end of the scroll for better flow */}
                    <button
                        onClick={() => logout()}
            ...
            >
                ...
                {/* Navigation with Liquid Slide Effect */}
