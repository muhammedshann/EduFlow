...
import { FetchAdminChatBot } from '../../Redux/AdminRedux/AdminChatBotSlice';
...
export default function ChatBotManagement() {
    ...
    /* ---------------- FETCH ---------------- */
    const fetch = async () => {
        const res = await dispatch(FetchAdminChatBot()).unwrap();
        ...
        <div className="p-6 md:p-10 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
            ...
            <header className="mb-8">
                <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-1 flex items-center">
                    <MessageSquare size={32} className="mr-3 text-purple-600 dark:text-purple-400" />
                    Chat Bot Management
                </h1>
                <p className="text-gray-500 dark:text-slate-400">
                    Total chat bot usage per user
                </p>
            </header>
                ...
                <div className="flex justify-between items-center mb-6 flex-wrap">
                    ...
                    <div className="relative w-full sm:w-80">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white rounded-lg focus:ring-purple-500 focus:border-purple-500 dark:focus:border-purple-400 outline-none transition-colors"
                        />
                    </div>
                </div>
