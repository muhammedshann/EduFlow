                ...
                <div className="px-8 pb-8 -mt-12 text-center relative z-10">
                    ...
                    <div className="space-y-5 text-left">
                        ...
                        <button 
                            ...
                            className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 active:scale-95 shadow-lg group ${
                                copied 
