...
export default function Settings() {
    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20 text-black dark:text-white transition-colors duration-300">
            Loading...
        </div>
    );
    ...
    return (
        ...
        <div className="min-h-screen flex justify-center py-6 px-4 md:py-12 pb-20 relative transition-colors duration-300 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20">
